...
public class C_GetDataFromDatabase extends AsyncTask<String, Integer, String> {

    public Interface_AsyncGetDBTask taskCompleted = null;
...
//        taskCompleted.GetDBTaskFinish(re_name,re_lat,re_long);   //Call function
